...
size_t				area__count_free_space_before(t_area *a, t_block *b, size_t until, t_free_block **last_encountered_fb);
size_t				area__count_free_space_after(t_area *a, t_block *b, size_t until);
