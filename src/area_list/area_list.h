...
typedef void	(*area_list__foreach_fn)(t_area *area, void *ctx);

t_area			*area_list__search(t_area_list *al, area_list__search_fn fn, void *ctx);
void			area_list__foreach(t_area_list *al, area_list__foreach_fn fn, void *ctx);
...
void			area_list__hexdump(t_area_list *al);
# ifdef MALLOC_LOG
